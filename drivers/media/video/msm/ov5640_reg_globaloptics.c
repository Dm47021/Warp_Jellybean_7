...
/*
 * Attention: 100ms delay for reg of "0x18" UNCONFIRMED
 */
...
{0x3a15, 0xd8}, 
{0x5183, 0x14}, 
{0x4009, 0x10}, //blc//ZTE_YGL_CAM_20110711,modifed for SNR
...
struct ov5640_reg_t ov5640_regs = {
    ...
    .lens_shading_D65_tbl = ov5640_lens_shading_D65_tbl,
	  .lens_shading_D65_tbl_size = ARRAY_SIZE(ov5640_lens_shading_D65_tbl),
	  .lens_shading_A_tbl = ov5640_lens_shading_A_tbl,
	  .lens_shading_A_tbl_size = ARRAY_SIZE(ov5640_lens_shading_A_tbl),
