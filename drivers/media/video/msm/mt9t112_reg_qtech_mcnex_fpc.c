...
/*-----------------------------------------------------------------------------------------
  ...
  --------     ----         -------------------------------------    ----------------------
  2011-09-19   lijing       update lens shading and wb param         ZTE_CAM_LJ_20110919
  2011-03-30   lijing       change af model from change register     ZTE_CAM_LJ_20110330
...
/*
 * ZTE_CAM_LJ_20110919
 * update lens shading and wb param
 */
#if 0
    //lens shading
    /*
...
#else
    //MCNEX___90%___Register Log 09/13/11 17:53:26]
    {0x3210, 0x00B0, WORD_LEN, 0},   // COLOR_PIPELINE_CONTROL
    {0x3640, 0x02B0, WORD_LEN, 0},   // P_G1_P0Q0
    {0x3642, 0xCEAB, WORD_LEN, 0},             // P_G1_P0Q1
    {0x3644, 0x3811, WORD_LEN, 0},   // P_G1_P0Q2
    {0x3646, 0xC34E, WORD_LEN, 0}, // P_G1_P0Q3
    {0x3648, 0xB1D0, WORD_LEN, 0}, // P_G1_P0Q4
    {0x364A, 0x7F0F, WORD_LEN, 0}, // P_R_P0Q0
    {0x364C, 0x96CC, WORD_LEN, 0}, // P_R_P0Q1
    {0x364E, 0x2C11, WORD_LEN, 0}, // P_R_P0Q2
    {0x3650, 0x860F, WORD_LEN, 0},   // P_R_P0Q3
    {0x3652, 0xA150, WORD_LEN, 0},   // P_R_P0Q4
    {0x3654, 0x7E4F, WORD_LEN, 0}, // P_B_P0Q0
    {0x3656, 0x854B, WORD_LEN, 0},   // P_B_P0Q1
    {0x3658, 0x6A50, WORD_LEN, 0},   // P_B_P0Q2
    {0x365A, 0x8CCF, WORD_LEN, 0},             // P_B_P0Q3
    {0x365C, 0x9ECF, WORD_LEN, 0},             // P_B_P0Q4
    {0x365E, 0x7ECF, WORD_LEN, 0},             // P_G2_P0Q0
    {0x3660, 0x916C, WORD_LEN, 0},   // P_G2_P0Q1
    {0x3662, 0x32F1, WORD_LEN, 0},   // P_G2_P0Q2
    {0x3664, 0xA24E, WORD_LEN, 0}, // P_G2_P0Q3
    {0x3666, 0xD290, WORD_LEN, 0}, // P_G2_P0Q4
    {0x3680, 0x34CD, WORD_LEN, 0}, // P_G1_P1Q0
    {0x3682, 0x0DCE, WORD_LEN, 0},             // P_G1_P1Q1
    {0x3684, 0x0EB1, WORD_LEN, 0}, // P_G1_P1Q2
    {0x3686, 0xE38F, WORD_LEN, 0}, // P_G1_P1Q3
    {0x3688, 0xBE92, WORD_LEN, 0}, // P_G1_P1Q4
    {0x368A, 0x066E, WORD_LEN, 0}, // P_R_P1Q0
    {0x368C, 0x1C4E, WORD_LEN, 0}, // P_R_P1Q1
    {0x368E, 0x7D30, WORD_LEN, 0}, // P_R_P1Q2
    {0x3690, 0x8E10, WORD_LEN, 0},   // P_R_P1Q3
    {0x3692, 0xAC32, WORD_LEN, 0}, // P_R_P1Q4
    {0x3694, 0x80AD, WORD_LEN, 0}, // P_B_P1Q0
    {0x3696, 0x576E, WORD_LEN, 0},   // P_B_P1Q1
    {0x3698, 0x332F, WORD_LEN, 0},   // P_B_P1Q2
    {0x369A, 0xA950, WORD_LEN, 0}, // P_B_P1Q3
    {0x369C, 0xBC70, WORD_LEN, 0}, // P_B_P1Q4
    {0x369E, 0xCF6D, WORD_LEN, 0},             // P_G2_P1Q0
    {0x36A0, 0x07CF, WORD_LEN, 0}, // P_G2_P1Q1
    {0x36A2, 0x12D0, WORD_LEN, 0}, // P_G2_P1Q2
    {0x36A4, 0xB410, WORD_LEN, 0}, // P_G2_P1Q3
    {0x36A6, 0x9751, WORD_LEN, 0},   // P_G2_P1Q4
    {0x36C0, 0x36F2, WORD_LEN, 0}, // P_G1_P2Q0
    {0x36C2, 0x3A4E, WORD_LEN, 0}, // P_G1_P2Q1
    {0x36C4, 0xE36E, WORD_LEN, 0}, // P_G1_P2Q2
    {0x36C6, 0x91B0, WORD_LEN, 0}, // P_G1_P2Q3
    {0x36C8, 0xC3D4, WORD_LEN, 0},             // P_G1_P2Q4
    {0x36CA, 0x27B2, WORD_LEN, 0}, // P_R_P2Q0
    {0x36CC, 0x900D, WORD_LEN, 0},             // P_R_P2Q1
    {0x36CE, 0x69F1, WORD_LEN, 0}, // P_R_P2Q2
    {0x36D0, 0x2070, WORD_LEN, 0}, // P_R_P2Q3
    {0x36D2, 0xDFD4, WORD_LEN, 0},             // P_R_P2Q4
    {0x36D4, 0x1412, WORD_LEN, 0}, // P_B_P2Q0
    {0x36D6, 0x004C, WORD_LEN, 0}, // P_B_P2Q1
    {0x36D8, 0xE6F1, WORD_LEN, 0}, // P_B_P2Q2
    {0x36DA, 0x8DB0, WORD_LEN, 0},             // P_B_P2Q3
    {0x36DC, 0x00D1, WORD_LEN, 0},             // P_B_P2Q4
    {0x36DE, 0x3512, WORD_LEN, 0}, // P_G2_P2Q0
    {0x36E0, 0x8A2C, WORD_LEN, 0}, // P_G2_P2Q1
    {0x36E2, 0xFAB0, WORD_LEN, 0},             // P_G2_P2Q2
    {0x36E4, 0x11ED, WORD_LEN, 0},             // P_G2_P2Q3
    {0x36E6, 0x9FF4, WORD_LEN, 0}, // P_G2_P2Q4
    {0x3700, 0x38AE, WORD_LEN, 0}, // P_G1_P3Q0
    {0x3702, 0xBC6F, WORD_LEN, 0}, // P_G1_P3Q1
    {0x3704, 0x8973, WORD_LEN, 0},   // P_G1_P3Q2
    {0x3706, 0x4E90, WORD_LEN, 0},   // P_G1_P3Q3
    {0x3708, 0x7854, WORD_LEN, 0},   // P_G1_P3Q4
    {0x370A, 0x2ACD, WORD_LEN, 0},             // P_R_P3Q0
    {0x370C, 0x5D8C, WORD_LEN, 0},             // P_R_P3Q1
    {0x370E, 0xE9B2, WORD_LEN, 0}, // P_R_P3Q2
    {0x3710, 0x2730, WORD_LEN, 0},   // P_R_P3Q3
    {0x3712, 0x5974, WORD_LEN, 0},   // P_R_P3Q4
    {0x3714, 0x35EC, WORD_LEN, 0}, // P_B_P3Q0
    {0x3716, 0x8FD0, WORD_LEN, 0}, // P_B_P3Q1
    {0x3718, 0x9A0F, WORD_LEN, 0}, // P_B_P3Q2
    {0x371A, 0x5452, WORD_LEN, 0},   // P_B_P3Q3
    {0x371C, 0xCE90, WORD_LEN, 0}, // P_B_P3Q4
    {0x371E, 0xB229, WORD_LEN, 0}, // P_G2_P3Q0
    {0x3720, 0x7A6D, WORD_LEN, 0}, // P_G2_P3Q1
    {0x3722, 0xC74F, WORD_LEN, 0}, // P_G2_P3Q2
    {0x3724, 0xB970, WORD_LEN, 0},   // P_G2_P3Q3
    {0x3726, 0x4A51, WORD_LEN, 0},   // P_G2_P3Q4
    {0x3740, 0xC8F2, WORD_LEN, 0}, // P_G1_P4Q0
    {0x3742, 0x2C70, WORD_LEN, 0},   // P_G1_P4Q1
    {0x3744, 0xAF36, WORD_LEN, 0}, // P_G1_P4Q2
    {0x3746, 0xA1D5, WORD_LEN, 0}, // P_G1_P4Q3
    {0x3748, 0x0D79, WORD_LEN, 0}, // P_G1_P4Q4
    {0x374A, 0xC192, WORD_LEN, 0}, // P_R_P4Q0
    {0x374C, 0x1AD2, WORD_LEN, 0},             // P_R_P4Q1
    {0x374E, 0xA416, WORD_LEN, 0}, // P_R_P4Q2
    {0x3750, 0xC0D5, WORD_LEN, 0}, // P_R_P4Q3
    {0x3752, 0x6FD8, WORD_LEN, 0}, // P_R_P4Q4
    {0x3754, 0xDE52, WORD_LEN, 0}, // P_B_P4Q0
    {0x3756, 0x0951, WORD_LEN, 0},   // P_B_P4Q1
    {0x3758, 0x8EF5, WORD_LEN, 0}, // P_B_P4Q2
    {0x375A, 0x8B75, WORD_LEN, 0}, // P_B_P4Q3
    {0x375C, 0x2258, WORD_LEN, 0},   // P_B_P4Q4
    {0x375E, 0xD172, WORD_LEN, 0}, // P_G2_P4Q0
    {0x3760, 0x6E31, WORD_LEN, 0},   // P_G2_P4Q1
    {0x3762, 0xA476, WORD_LEN, 0},   // P_G2_P4Q2
    {0x3764, 0xD3F5, WORD_LEN, 0}, // P_G2_P4Q3
    {0x3766, 0x0C39, WORD_LEN, 0},   // P_G2_P4Q4
    {0x3782, 0x0300, WORD_LEN, 0},   // CENTER_ROW
    {0x3784, 0x03C0, WORD_LEN, 0},   // CENTER_COLUMN
    {0x3210, 0x00B8, WORD_LEN, 0},   // COLOR_PIPELINE_CONTROL
#endif  
    {0x098E, 0x48B0 ,WORD_LEN,0},	// MCU_ADDRESS [CAM1_AWB_CCM_L_0]
	{0x0990, 0x0242 ,WORD_LEN,0},	// MCU_DATA_0
    ...
    {0x0990, 0x0084, WORD_LEN, 0},   // MCU_DATA_0 //0x0089 lijing 0915
...
static struct mt9t11x_i2c_reg_conf const wb_auto_tbl[] = {
     ...
     * update lens shading and wb param
     */
    {0x098E, 0x48C2 ,WORD_LEN,0},        // MCU_ADDRESS [CAM1_AWB_CCM_L_9] //add at here
    {0x0990, 0x001E ,WORD_LEN,0},        // MCU_DATA_0 
    {0x098E, 0x48C4 ,WORD_LEN,0},        // MCU_ADDRESS [CAM1_AWB_CCM_L_10] 
    {0x0990, 0x003E ,WORD_LEN,0},        // MCU_DATA_0 
     ...
     * update lens shading and wb param
     */
    {0x098E, 0x48D8 ,WORD_LEN,0},        // MCU_ADDRESS [CAM1_AWB_CCM_RL_9] //add at here
    {0x0990, 0x0015 ,WORD_LEN,0},        // MCU_DATA_0 
    {0x098E, 0x48DA ,WORD_LEN,0},        // MCU_ADDRESS [CAM1_AWB_CCM_RL_10] 
    {0x0990, 0xFFE9 ,WORD_LEN,0},        // MCU_DATA_0  
...
static struct mt9t11x_i2c_reg_conf const af_tbl[] = {
    ...
    /*
     * ZTE_CAM_LJ_20110330
     * change AF mode from full scan to climbing hill mode
     */
    {0x0990, 0x0008, WORD_LEN, 0},    // MCU_DATA_0  0x0002 -> 0x0008
