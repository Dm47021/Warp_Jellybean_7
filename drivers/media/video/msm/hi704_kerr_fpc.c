...
/*-----------------------------------------------------------------------------------------
  ...
  --------     ----         -------------------------------------    ----------------------
  2011-04-22   lijing       modify sensor angle                      ZTE_CAM_LJ_20110422
...
#define HI704_GPIO_SWITCH_CTL     181
				                 ...
				                 struct msm_sensor_ctrl *s)
{
    ...
    /*
     * modify sensor angle from 90 to 0, else snapshot angle is 90 rotated
     * ZTE_CAM_LJ_20110414_01 ZTE_CAM_LJ_20110422
     */
    s->s_mount_angle = 0;
 ...
 */
	...
	return msm_camera_drv_start(pdev, hi704_sensor_probe,1);
#else
