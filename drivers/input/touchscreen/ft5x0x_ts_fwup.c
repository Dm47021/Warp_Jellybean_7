...
#define CTPM_FW_NAME	"Ver15_20120116_038_9633_bladeplus_app.bin"
#endif
...
static unsigned char CTPM_FW[]=
{
	...
	//#include "Ver10_20110630_038_9633_bladeplus_app.i" //ZTE_TS_XYM_20110711
	#include "Ver11_20110811_038_9633_bladeplus_app.i" 		// for usb power supply issue
#else
#endif
};
...
{
	//char *tgt_fw = CTPM_FW_NAME;//"Ver11_20110811_038_9633_bladeplus_app.bin";

	//printk("xiayc~`Ft5x0x_fwupdate: %s \n", tgt_fw);
	printk("xiayc~`Ft5x0x_fwupdate: %s \n", CTPM_FW_NAME);
	//download_firmware_main(tgt_fw);
	//return fts_ctpm_write_fw_with_app_file(client,tgt_fw);
