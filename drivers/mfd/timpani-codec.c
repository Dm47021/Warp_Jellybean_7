...
#if 1//zrlean
int adie_codec_debug_write(u8 reg, u8 mask, u8 val)
{
	return adie_codec_write(reg,mask,val);
}

int adie_codec_debug_read(u8 reg,u8 *val)
{
	return adie_codec_read(reg,val);
}
