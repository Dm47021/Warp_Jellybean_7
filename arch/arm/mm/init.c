...
//hml add reserve RAM for splash.img
#ifdef CONFIG_ZTE_PLATFORM
#define MSM_RAM_SPLASH_BASE 0xfb00000
#define MSM_RAM_SPLASH_SIZE 0x400000  
#endif
...
//hml add to reserve splash ram
#ifdef CONFIG_ZTE_PLATFORM
      if ((MSM_RAM_SPLASH_BASE) && (MSM_RAM_SPLASH_SIZE))
	   reserve_bootmem(MSM_RAM_SPLASH_BASE,MSM_RAM_SPLASH_SIZE, BOOTMEM_DEFAULT);
#endif
...
#ifdef CONFIG_ZTE_PLATFORM
if ((MSM_RAM_SPLASH_BASE) && (MSM_RAM_SPLASH_SIZE))
    totalram_pages += free_area(__phys_to_pfn(MSM_RAM_SPLASH_BASE),
                                   __phys_to_pfn(MSM_RAM_SPLASH_BASE+MSM_RAM_SPLASH_SIZE),
                               "splash image");
#endif
}
