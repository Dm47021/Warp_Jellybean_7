...
--------     ----    ----------------------------------------------------------------
2011-07-27   lijing     change avdd and motor from 2.6v to 2.8v ZTE_CAM_LJ_20110727
2011-07-14   yangxs  Change Timpani Codec PowerUp Sequence      ZTE_AUDIO_YXS_20110714
2011-05-10   yeganlin	add verg for motor alone.		        ZTE_CAM_YGL_20110510
2011-04-02   xiayc	    add keypad backlight support.		    ZTE_KP_XIAYC_20110402
2011-03-15	 fengyuao	move sensors to qup-i2c,				ZTE_FAY_SENSORS_20110315
2011-03-15	 jiangfeng	去掉PM8058 GPIO40的配置,				ZTE_PM_JIANGFENG_20110315
2011-03-10	 xiayc		add synaptics touchscreen support.		ZTE_TS_XIAYC_20110310
2011-02-11   rjg        add f3 log support                      ZTE_F3LOG_RJG_20110211
2010-12-15   wly        取消电阻屏睡眠唤醒时对s2电压的控制      ZTE_WLY_CRDB00587509
2010-12-13   wly        移植v9＋                               	ZTE_WLY_V9_20101213
2010-12-09   wly        add atmel driver                        ZTE_ATMEL_TS_WLY_20101209
2010/10/18   JIANGFENG  ZTE_JIANGFENG_20101018_01, 添加FTM功能
2010-09-03   liwei      Add V9 7 inch touch screen basic 
						function support.		   				ZTE_TOUCH_LIWEI_20100903
=========================================================================================
*/
...
//ZTE_JIANGFENG_20101018_01, start
...
//ZTE_PM_JIANGFENG_20110315, start
...
/* add camera sensor I2C infoZTE_LJ_CAM_20100916 begin */
...
#endif
#endif
/* add sensor I2C info ZTE_LJ_CAM_20100916 end */
};

#if 1

#ifdef CONFIG_MSM_CAMERA
/* Config camera GPIO ZTE_LJ_CAM_201009016 begin */ 
...
/* add sensor init data structure ZTE_LJ_CAM_201009016 begin*/
#ifdef CONFIG_MT9P111
/*
 * Commented by zhang.shengjie
 *
...
/* add sensor init data structure ZTE_LJ_CAM_201009016 end */
#endif
#ifdef CONFIG_OV5640
/*
 * Commented by zhang.shengjie
...
/* ZTE_Audio_gushenggao_110624, for N850 reset GPIO, start */
#define TIMPANI_RESET_GPIO	86 //1
/* ZTE_Audio_gushenggao_110624, for N850 reset GPIO, end */

static struct vreg *vreg_marimba_1;
static struct vreg *vreg_marimba_2;

/* ZTE_AUDIO_YXS_20110714, start */
#if 1
...
//ZTE_WLY_CRDB00587509,END
#if defined( CONFIG_MACH_V9PLUS) // ZTE_TOUCH_LIWEI_20100903, set max_x and max_y for V9 screen
...
static struct marimba_tsadc_platform_data marimba_tsadc_pdata = {
	...
	//.level_vote	     =  marimba_tsadc_vote,//ZTE_WLY_CRDB00587509
...
#if defined(ZTE_SEAN) 	//chenchongbao.20110822 for 8903 charge full state detect.
...
static struct msm_gpio lcdc_gpio_config_data[] = {
	...
	{ GPIO_CFG(123, 0, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA), "lcd_spi_sdo" },
	{ GPIO_CFG(122, 0, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA), "lcd_spi_cs" },
	{ GPIO_CFG(121, 0, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA), "lcd_spi_sdi" },
...
static struct resource bluesleep_resources[] = {
	...
	{
		.name	= "gpio_ext_wake",
		.start	= 39,   //ZTE_BT_QXX_20100709:42 to 90
		.end	= 39,     //ZTE_BT_QXX_20100709:42 to 90
		.flags	= IORESOURCE_IO,
	},
	{
		.name	= "host_wake",
...
/*ZTE_BOOT_HUANGYANJUN_20110412_01 begin*/
#ifdef CONFIG_ZTE_PLATFORM
...
//ZTE_BOOT_HUANGYANJUN_20110412_01, end
	...
	bt_power_init();
	msm_sensors_power_supply(); /*ZTE_ALS_100927*/
#ifdef CONFIG_I2C_SSBI
