...
static struct pmic8058_keypad_data surf_keypad_data = {
	.input_name		= "skateplus_keypad",
	.input_phys_device	= "skateplus_keypad/input0",
	.num_rows		= 12,
	.num_cols		= 8,
	.rows_gpio_start	= 8,
	.cols_gpio_start	= 0,
...
/* ZTE_Audio_CJ_110523, chenjun, 2011-05-23, start */
#define TIMPANI_RESET_GPIO	86 // 1
/* ZTE_Audio_CJ_110523, chenjun, 2011-05-23, end */
...
#if 0		/* chenchongbao.2011.8.2 for 8903 gpio configuration EC:614000930535 */
...
MACHINE_START(SKATEPLUS, "skateplus")
#ifdef CONFIG_MSM_DEBUG_UART
	.phys_io  = MSM_DEBUG_UART_PHYS,
	.io_pg_offst = ((MSM_DEBUG_UART_BASE) >> 18) & 0xfffc,
#endif
