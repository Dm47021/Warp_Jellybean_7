...
--------      ----          -----------------------------------------------------------------------------------------
2011-03-24   lijing         add 0.3M camera support                                             ZTE_CAM_LJ_20110324
...
2010-09-03   liwei          Add V9 7 inch touch screen basic function support                	ZTE_TOUCH_LIWEI_20100903
======================================================================================================================
*/
...
static const unsigned int surf_keymap[] = {
	...
	KEY(7, 3, KEY_RESERVED), /* REVISIT - SYM */
	...
	KEY(9, 5, KEY_RESERVED),
	KEY(9, 6, KEY_RESERVED),
	KEY(9, 7, KEY_RESERVED),
	...
	KEY(11, 1, KEY_RESERVED),  /* START */
	KEY(11, 2, KEY_RESERVED),
	KEY(11, 3, KEY_RESERVED),
	KEY(11, 4, KEY_RESERVED),
	KEY(11, 5, KEY_RESERVED),
...
static struct pmic8058_keypad_data surf_keypad_data = {
	.input_name		= "v9plus_keypad",
	.input_phys_device	= "v9plus_keypad/input0",
	.num_rows		= 12,
	.num_cols		= 8,
	.rows_gpio_start	= 8,
	.cols_gpio_start	= 0,
...
static struct i2c_board_info msm_camera_boardinfo[] __initdata = {
	{
		I2C_BOARD_INFO("bh1721", 0x23), /*ZTE_ALS_100927*/
	},
#if 1
...
//ZTE_CAM_LJ_20110324
     ...
     *
     * Refer to drivers/media/video/msm/hi704.c
     */
    {
...
static struct msm_gpio lcdc_gpio_config_data[] = {
	...
	{ GPIO_CFG(3, 0, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA), "lcd_avdd_pd" },
	{ GPIO_CFG(133, 0, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA), "lvds_pd" },
	{ GPIO_CFG(143, 0, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA), "lcd_pwr_en" },
...
static struct msm_gpio uart2_config_data[] = {
	...
	//{ GPIO_CFG(50, 2, GPIO_CFG_INPUT,   GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA), "UART2_CTS"},//ZTE_CAM_LJ_20110324
