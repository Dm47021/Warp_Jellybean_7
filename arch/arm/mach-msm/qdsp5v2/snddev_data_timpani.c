...
#endif
//ZTE_Audio_gushenggao_110725, for N850, end
...
//ZTE_Audio_gushenggao_110725, for N850, start
//ZTE_AUDIO_HUDIE_20110902, for P855A11
#if 1 // (defined(CONFIG_MACH_SEAN)||defined(CONFIG_MACH_SKATEPLUS)) //songyy speaker rx 
